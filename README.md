<a name="readme-top">ENUMERABLE</a>
...
**ENUMERABLE** is an exercise to use Ruby syntax for basic programming operations and use modules inside a class.
...
This project is [MIT](https://github.com/Thoth1111/Enumerable/blob/main/license) licensed.
